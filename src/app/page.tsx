    ...
    <>
      ...
      >
        <section>
          ...
          <ul className={cn("flex flex-col gap-10 lg:hidden")}>
          ...
          <ul className={cn("hidden lg:block")}>
            <EmblaCarousel
              slides={customerVoices.map((voice, i) => (
                <li key={i}>
                  <Link href="/" className={cn("group flex flex-col gap-5")}>
                    <div className={cn("overflow-hidden rounded-lg")}>
                      <Image
                        src={voice.image}
                        alt={voice.company}
                    ...
                    <p
                      className={cn("text-[15px] font-normal text-neutral-500")}
                    >
                      {voice.company}
                    </p>
